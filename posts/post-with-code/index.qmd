...
![Users can create a table that links to an external Google Sheet by providing the URL and sheet range](create_external_table.jpg)
...
![3 main components in the data pipeline](flow.jpg)
